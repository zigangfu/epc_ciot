...
// Timing related to NB-IoT

// The gap between UL DCI and actual UL data (with I_delay = 0)
// TODO: properly handle 3.75kHz carrier
#define FDD_DELAY_UL_NB_MS 9

// The time to receive the first UL subframe calculated from DCI transmission
// Need to add two part's delay: RF Tx (4) + DCI-to-DATA (9)
#define TTI_UL_RX_NB(tti) (TTI_ADD(tti, FDD_DELAY_UL_NB_MS + FDD_HARQ_DELAY_DL_MS))

#define TTIMOD_SZ 40  // base 20sf + 20sf koffset
