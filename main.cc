...
{
  // return std::string(tsnbiot_get_build_mode());
  return "";
}

std::string get_build_info()
{
  // if (std::string(tsnbiot_get_build_info()).find("  ") != std::string::npos) {
  //   return std::string(tsnbiot_get_build_info());
  // }
  // return std::string(tsnbiot_get_build_info());
...
{
  // std::stringstream ss;
  // ss << "Built in " << tsnbiot_get_build_mode() << " mode using " << tsnbiot_get_build_info() << "." << std::endl;
  // return ss.str();
  return "";
}
