...
#include "asn1/gtpc_ies.h"
#include "asn1/liblte_mme.h"
#include "common/buffer_pool.h"
#include "common/security.h"
#include "interfaces/epc_interfaces.h"
...
public:
  ...
  static bool handle_nb_attach_request(uint32_t                enb_ue_s1ap_id,
                                    struct sctp_sndrcvinfo* enb_sri,
                                    srslte::byte_buffer_t*  nas_rx,
                                    const nas_init_t&       args,
                                    const nas_if_t&         itf,
  ...
  // NB-IoT Control Plane Service request messages
  static bool handle_nb_control_plane_service_request(uint32_t                m_tmsi,
                                     uint32_t                enb_ue_s1ap_id,
                                     struct sctp_sndrcvinfo* enb_sri,
                                     srslte::byte_buffer_t*  nas_rx,
                                     const nas_init_t&       args,
  ...
  // NB-IoT ESM data transport messages
  bool handle_esm_data_transport(srslte::byte_buffer_t* nas_rx);
  ...
  bool pack_service_accept(srslte::byte_buffer_t* nas_buffer, uint16_t ebi_info);
  ...
  bool send_esm_data_transport(srslte::byte_buffer_t* user_data);
  ...
  void cipher_decrypt_esm_msg(LIBLTE_BYTE_MSG_STRUCT* esm_msg, uint8_t count);
  ...
  std::deque<srslte::byte_buffer_t*> pending_ul_pkt = {};
